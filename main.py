...
gbtn = tk.Button(root, text="Get Data", font=p,
                 relief='solid', command=get_country_data)
gbtn.pack()

rbtn = tk.Button(root, text="Reload", font=p, relief='solid', command=reload)
rbtn.pack()
